...
The main part of this task is understanding how the function that called "bubble_sort_sequence_executor_aka_transposition_performer" works
and for what purpose is it called.
 ## Writeup
 ...
 3.  After it you need to press the best F5 button in the world. This action will move you to the HexRays decompiler
 4.  Firstly, I take my attention focus to massive of DWORD(4 bytes) elements, which are int I guess.
 ...
 5. Moving further through the pseudocode, we see a block that checks an array of characters(argv - an program argument) to see if they represent numbers
    from 0 to 9.
...
6. Take a look at next the screenshot, which shows how "bubble_sort_sequence_executor_aka_transposition_performer" works.
...
7. We've almost solved the problem. Let`s take a look at the check that determines whether we can get the flag or not. For passing this check we must create
